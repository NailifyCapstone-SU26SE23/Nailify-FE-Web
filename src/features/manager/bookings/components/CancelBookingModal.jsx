...
export function CancelBookingModal({
  ...
  return (
    ...
    >
      <div className="bg-gradient-to-r from-[#fff0dd] to-[#f5d0a0] px-6 pt-6 pb-10">
        <div className="flex items-center gap-4">
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#db8520] text-white">
            <XCircle size={20} />
          </div>
          <div>
            <h2 className="text-xl font-extrabold text-[#402542]">Cancel Booking</h2>
          </div>
        </div>
      </div>
      <div className="-mt-6 space-y-4 rounded-[24px] bg-white px-6 pt-6 pb-6">
        ...
        <div className="flex gap-3 pt-1">
          ...
          <button
            ...
            className="flex-1 rounded-full bg-[#db8520] px-4 py-2.5 text-xs font-bold text-white transition hover:bg-[#c8781d]"
            disabled={isLoading}
          >
            {isLoading ? (
