    ...
    <Modal
      title={
        <div className="flex items-center gap-2 text-rose-600">
          <AlertCircle size={18} />
          <span className="font-bold text-sm">Confirm Refund Payment</span>
        </div>
      }
      open={open}
      onCancel={onCancel}
    ...
    >
      <div className="py-2 space-y-2.5 text-xs text-slate-600 leading-relaxed">
        ...
        <p className="bg-rose-50 text-rose-700 p-3.5 rounded-xl border border-rose-100 text-[11px]">
          <strong>Warning:</strong> This will request a refund from the PayOS payment gateway. The customer will receive their funds back according to banking timelines.
        </p>
      </div>
    </Modal>
  );
