      ...
      },
      {
        ...
        render: (_, skillType) => (
          <ActionButtons
            ...
            onEdit={() => navigate(getAdminSkillTypeDetailRoute(skillType.skillTypeId), { state: { startInEdit: true } })}
            onDelete={() => setDeleteTarget(skillType)}
            showDelete={skillType?.status === "Active"}
          />
        ),
      },
    ], [navigate, t],
      ...
      <section className="flex min-h-full flex-col gap-4">
        ...
        <section className="overflow-hidden rounded-lg border border-[#f8dce8] bg-white shadow-[0_12px_28px_rgba(236,72,153,0.07)]">
          {/* <div className="border-b border-[#f6dbe7] px-5 py-4">
            <h2 className="text-sm font-bold text-[#432744]">{t("adminSkillTypes.skillTypes")}</h2>
