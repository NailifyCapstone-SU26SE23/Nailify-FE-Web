      ...
      >
        ...
        <div className="mt-5 flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
          <button
            ...
            onClick={onCancel}
            disabled={loading}
            className={`inline-flex items-center justify-center rounded-full border px-4 py-2 font-extrabold uppercase tracking-[0.08em] transition disabled:cursor-not-allowed disabled:opacity-60 ${palette.cancelClassName}`}
          >
            {cancelText}
          </button>
          <button
