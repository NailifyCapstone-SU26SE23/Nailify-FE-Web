...
const STAFF_BOOKING_EXPERIENCES = {
  "BKG-2408": {
    ...
    bookingInfo: [
      ...
      { label: "Deposit Paid", value: "200,000 VNĐ", note: "Confirmed", tone: "success" },
    ...
    checklist: [
      ...
      { label: "Total price confirmed - 650,000 VNĐ (deposit deducted)", checked: true },
...
export const getStaffDesignStudioExperienceById = (bookingId) =>
  ...
  (() => {
    ...
    const defaultTemplate = {
      ...
      price: booking.total.includes("VNĐ") ? booking.total.replace(",000 VNĐ", "k").replace(" VNĐ", "") : "$40",
    ...
    return {
      ...
      templates: [
        defaultTemplate,
        {
          ...
          tags: ["Chrome", "Pearl"],
          accent: "Signature",
          accentClassName: "bg-[#e9f1ff] text-[#4f77d9]",
          ctaLabel: "Select",
        },
        {
          id: "korean-nude",
          ...
          tags: ["Korean", "Clean"],
          accent: "Everyday",
          accentClassName: "bg-[#f7eddb] text-[#b4822d]",
          ctaLabel: "Select",
        },
        {
          id: "french-ombre",
          ...
          tags: ["French", "Ombre"],
          accent: "Classic",
          accentClassName: "bg-[#ffe7f0] text-[#d45588]",
          ctaLabel: "Select",
        },
        {
          id: "wedding-floral",
          ...
          tags: ["Bridal", "Floral"],
          accent: "Premium",
          accentClassName: "bg-[#edf8ea] text-[#2f9a52]",
          ctaLabel: "Select",
        },
        {
          id: "minimal-beige",
          ...
          tags: ["Beige", "Minimal"],
          accent: "Fast",
          accentClassName: "bg-[#f6efe6] text-[#9a6f46]",
          ctaLabel: "Select",
        },
        {
          id: "soft-nude",
      ...
      builder: {
        ...
        priceRows: [
          ["Base Price", booking.total.includes("VNĐ") ? booking.total.replace(" VNĐ", "") : "$40.00"],
          ["Decoration Fee", "$6.00"],
          ["Extra Services", "$0.00"],
        ],
        totalPrice: booking.total.includes("VNĐ") ? booking.total.replace(" VNĐ", "") : "$46.00",
